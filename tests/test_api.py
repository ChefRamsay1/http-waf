...
class TestApi:
    ...
    def test_simple_request(self):
        ...
        assert response.status_code == 403  # ensure return status is
    ...
    # test nested non malicious request
    def test_request_malicious_string(self):
        url = 'http://localhost:5000/api/handle-request'
        headers = {'Content-Type': 'application/json'}
    ...
    # test to benchmark performance of waf with small json object
    # Benchmark Result:
    # Name (time in ms)                             Min                Max               Mean            StdDev             Median               IQR            Outliers       OPS            Rounds  Iterations
    # ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    # test_request_perf_benchmark                3.8607 (1.0)      53.7886 (2.60)      4.7046 (1.0)      3.6167 (2.18)      4.3318 (1.0)      0.4497 (1.0)          2;11  212.5580 (1.0)         195           1
    # Summary: benchmark yields 212 Operations per second with 195 rounds
    def test_request_perf_benchmark(self, benchmark):
        url = 'http://localhost:5000/api/handle-request'
        headers = {'Content-Type': 'application/json'}
    ...
    # test to benchmark performance of waf with massive json object
